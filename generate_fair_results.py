...
en_data = {
    ...
    'seikkailijasirkka': {
        ...
        'info': "Check out at least the following: <a href='https://www.oph.fi/fi/ohjelmat/erasmus-nuisotyontekijoiden-liikkuvuushanke' target='_blank'>Erasmus+ mobility of youth workers (in Finnish)</a>, <a href='https://www.oph.fi/fi/ohjelmat/discovereu' target='_blank'>DiscoverEU (in Finnish)</a>, <a href='https://www.oph.fi/en/education-development-and-internationalisation/erasmus-programme-finland-2021-2027/international-training-youth-sector' target='_blank'>international training</a>.",
...
sv_data = {
    ...
    'osallisuuskimalainen': {
        ...
        'og_desc': "Du surrar av iver när unga hittar nya sätt että göra sin egen röst hörd. Gör testet!"
    }
}
