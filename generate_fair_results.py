...
en_data = {
    'unelmoijakorento': {
        ...
        'info': "Check out at least the following:<br><a href='https://www.oph.fi/fi/ohjelmat/euroopan-solidaarisuusjoukot-solidaarisuushanke' target='_blank' rel='noopener noreferrer'>The European Solidarity Corps’ solidarity projects (in Finnish)</a><br> and <a href='https://www.oph.fi/fi/ohjelmat/euroopan-solidaarisuusjoukot-vapaaehtoistoiminta' target='_blank' rel='noopener noreferrer'>volunteer projects (in Finnish)</a><br> as well as <a href='https://www.oph.fi/en/education-development-and-internationalisation/erasmus-programme-finland-2021-2027/international-training-youth-sector' target='_blank' rel='noopener noreferrer'>international trainings</a>.",
    ...
    'kehittajakehraaja': {
        ...
        'info': "Check out at least the following:<br><a href='https://www.oph.fi/fi/ohjelmat/erasmus-nuorisoalalle-yhteistyohankkeet' target='_blank' rel='noopener noreferrer'>Erasmus+ partnerships for cooperation (in Finnish)</a><br> and <a href='https://www.oph.fi/en/education-development-and-internationalisation/erasmus-programme-finland-2021-2027/international-training-youth-sector' target='_blank' rel='noopener noreferrer'>international trainings</a>.",
    ...
    'hallintomittari': {
        ...
        'info': "Check out at least the following:<br><a href='https://www.oph.fi/fi/ohjelmat/erasmus-nuorisoalalle-hakuajat-ja-neuvonnat' target='_blank' rel='noopener noreferrer'>Briefings for Erasmus+ projects (in Finnish)</a><br> and <a href='https://www.oph.fi/fi/ohjelmat/euroopan-solidaarisuusjoukkojen-hakuajat-ja-neuvonnat' target='_blank' rel='noopener noreferrer'>European Solidarity Corps projects (in Finnish)</a>, <br><a href='https://www.oph.fi/en/education-development-and-internationalisation/erasmus-programme-finland-2021-2027/international-training-youth-sector' target='_blank' rel='noopener noreferrer'>international trainings</a>.",
    ...
    'seikkailijasirkka': {
        ...
        'info': "Check out at least the following:<br><a href='https://www.oph.fi/fi/ohjelmat/erasmus-nuorisotyontekijoiden-liikkuvuushanke' target='_blank' rel='noopener noreferrer'>Erasmus+ mobility of youth workers (in Finnish)</a>, <br><a href='https://www.oph.fi/fi/ohjelmat/discovereu' target='_blank' rel='noopener noreferrer'>DiscoverEU (in Finnish)</a>, <br><a href='https://www.oph.fi/en/education-development-and-internationalisation/erasmus-programme-finland-2021-2027/international-training-youth-sector' target='_blank' rel='noopener noreferrer'>international trainings</a>.",
    ...
    'rohkaisijakuoriainen': {
        ...
        'info': "Check out at least the following:<br><a href='https://www.oph.fi/fi/ohjelmat/euroopan-solidaarisuusjoukot-solidaarisuushanke' target='_blank' rel='noopener noreferrer'>The European Solidarity Corps’ solidarity projects (in Finnish)</a>, <br><a href='https://www.oph.fi/fi/ohjelmat/erasmus-nuorten-osallistumishanke' target='_blank' rel='noopener noreferrer'>Erasmus+ youth participation activities (in Finnish)</a>, <br><a href='https://www.oph.fi/en/internationalisation/eurodesk' target='_blank' rel='noopener noreferrer'>Eurodesk youth information network</a>.",
    ...
    'osallisuuskimalainen': {
        ...
        'info': "Check out at least the following:<br><a href='https://www.oph.fi/fi/ohjelmat/euroopan-solidaarisuusjoukot-vapaaehtoistoiminta' target='_blank' rel='noopener noreferrer'>The European Solidarity Corps’ volunteer projects (in Finnish)</a>, <br><a href='https://www.oph.fi/fi/ohjelmat/erasmus-nuorisovaihto' target='_blank' rel='noopener noreferrer'>Erasmus+ youth exchanges (in Finnish)</a>.",
...
sv_data = {
    'unelmoijakorento': {
        ...
        'info': "Ta gärna del av följande:<br><a href='https://www.oph.fi/sv/program/europeiska-solidaritetskaren-solidaritetsprojekt' target='_blank' rel='noopener noreferrer'>Europeiska solidaritetskårens solidaritetsprojekt</a><br> och <a href='https://www.oph.fi/sv/program/europeiska-solidaritetskaren-volontarverksamhet' target='_blank' rel='noopener noreferrer'>volontärprojekt</a><br> samt <a href='https://www.oph.fi/sv/program/internationella-utbildningar-aktorer-pa-ungdomsomradet' target='_blank' rel='noopener noreferrer'>internationella utbildningar</a>.",
    ...
    'kehittajakehraaja': {
        ...
        'info': "Ta gärna del av följande:<br><a href='https://www.oph.fi/sv/program/erasmus-ungdomssektorn-partnerskap-samarbete' target='_blank' rel='noopener noreferrer'>Erasmus+ partnerskap för samarbete</a><br> och <a href='https://www.oph.fi/sv/program/internationella-utbildningar-aktorer-pa-ungdomsomradet' target='_blank' rel='noopener noreferrer'>internationella utbildningar</a>.",
    ...
    'hallintomittari': {
        ...
        'info': "Ta gärna del av följande:<br><a href='https://www.oph.fi/sv/program/ansokningstiderna-och-radgivning-ansokan' target='_blank' rel='noopener noreferrer'>Ansökningsrådgivningar för Erasmus+-projekt</a><br> och <a href='https://www.oph.fi/sv/program/ansokningstider-och-radgivningar-europeiska-solidaritetskaren' target='_blank' rel='noopener noreferrer'>projekt inom Europeiska solidaritetskåren</a>, <br><a href='https://www.oph.fi/sv/program/internationella-utbildningar-aktorer-pa-ungdomsomradet' target='_blank' rel='noopener noreferrer'>internationella utbildningar</a>.",
    ...
    'seikkailijasirkka': {
        ...
        'info': "Ta gärna del av följande:<br><a href='https://www.oph.fi/sv/program/erasmus-mobilitetsprojekt-ungdomsarbetare' target='_blank' rel='noopener noreferrer'>Erasmus+ mobilitetsprojekt för ungdomsarbetare</a>, <br><a href='https://www.oph.fi/sv/program/discovereu' target='_blank' rel='noopener noreferrer'>DiscoverEU</a>, <br><a href='https://www.oph.fi/sv/program/internationella-utbildningar-aktorer-pa-ungdomsomradet' target='_blank' rel='noopener noreferrer'>internationella utbildningar</a>.",
    ...
    'rohkaisijakuoriainen': {
        ...
        'info': "Ta gärna del av följande:<br><a href='https://www.oph.fi/sv/program/europeiska-solidaritetskaren-solidaritetsprojekt' target='_blank' rel='noopener noreferrer'>Europeiska solidaritetskårens solidaritetsprojekt</a>, <br><a href='https://www.oph.fi/sv/program/erasmus-ungdomsverksamhet' target='_blank' rel='noopener noreferrer'>Erasmus+ ungdomsverksamhet</a><br> och <a href='https://www.oph.fi/sv/internationalisering/eurodesk' target='_blank' rel='noopener noreferrer'>Eurodesk-nätverket för ungdomsinformation</a>.",
    ...
    'osallisuuskimalainen': {
        ...
        'info': "Ta gärna del av följande:<br><a href='https://www.oph.fi/sv/program/europeiska-solidaritetskaren-volontarverksamhet' target='_blank' rel='noopener noreferrer'>Europeiska solidaritetskårens volontärprojekt</a><br> och <a href='https://www.oph.fi/sv/program/erasmus-ungdomsutbyte' target='_blank' rel='noopener noreferrer'>Erasmus+ ungdomsutbyten</a>.",
...
fi_data = {
    'unelmoijakorento': {
        ...
        'info': "Tutustu ainakin näihin:<br><a href='https://www.oph.fi/fi/ohjelmat/euroopan-solidaarisuusjoukot-solidaarisuushanke' target='_blank' rel='noopener noreferrer'>Euroopan solidaarisuusjoukkojen solidaarisuushankkeet</a><br> ja <a href='https://www.oph.fi/fi/ohjelmat/euroopan-solidaarisuusjoukot-vapaaehtoistoiminta' target='_blank' rel='noopener noreferrer'>vapaaehtoishankkeet</a><br> sekä <a href='https://www.oph.fi/fi/ohjelmat/kansainvaliset-koulutukset-nuorisoalan-toimijoille' target='_blank' rel='noopener noreferrer'>kansainväliset koulutukset</a>.",
    ...
    'hallintomittari': {
        ...
        'info': "Tutustu ainakin näihin:<br><a href='https://www.oph.fi/fi/ohjelmat/erasmus-nuorisoalalle-hakuajat-ja-neuvonnat' target='_blank' rel='noopener noreferrer'>Hakuneuvonnat Erasmus+ -hankkeille</a><br> ja <a href='https://www.oph.fi/fi/ohjelmat/euroopan-solidaarisuusjoukkojen-hakuajat-ja-neuvonnat' target='_blank' rel='noopener noreferrer'>Euroopan solidaarisuusjoukot -hankkeille</a>, <br><a href='https://www.oph.fi/fi/ohjelmat/kansainvaliset-koulutukset-nuorisoalan-toimijoille' target='_blank' rel='noopener noreferrer'>kansainväliset koulutukset</a>.",
    ...
    'seikkailijasirkka': {
        ...
        'info': "Tutustu ainakin näihin:<br><a href='https://www.oph.fi/fi/ohjelmat/erasmus-nuorisotyontekijoiden-liikkuvuushanke' target='_blank' rel='noopener noreferrer'>Erasmus+ nuorisotyöntekijöiden liikkuvuushankkeet</a>, <br><a href='https://www.oph.fi/fi/ohjelmat/discovereu' target='_blank' rel='noopener noreferrer'>DiscoverEU</a>, <br><a href='https://www.oph.fi/fi/ohjelmat/kansainvaliset-koulutukset-nuorisoalan-toimijoille' target='_blank' rel='noopener noreferrer'>kansainväliset koulutukset</a>.",
    ...
    'rohkaisijakuoriainen': {
        ...
        'info': "Tutustu ainakin näihin:<br><a href='https://www.oph.fi/fi/ohjelmat/euroopan-solidaarisuusjoukot-solidaarisuushanke' target='_blank' rel='noopener noreferrer'>Euroopan solidaarisuusjoukkojen solidaarisuushankkeet</a>, <br><a href='https://www.oph.fi/fi/ohjelmat/erasmus-nuorten-osallistumishanke' target='_blank' rel='noopener noreferrer'>Erasmus+ nuorten osallistumishankeet</a>, <br><a href='https://www.oph.fi/fi/kansainvalisyys/eurodesk' target='_blank' rel='noopener noreferrer'>Eurodesk-nuorisotiedotusverkosto</a>.",
    ...
    'osallisuuskimalainen': {
        ...
        'info': "Tutustu ainakin näihin:<br><a href='https://www.oph.fi/fi/ohjelmat/euroopan-solidaarisuusjoukot-vapaaehtoistoiminta' target='_blank' rel='noopener noreferrer'>Euroopan solidaarisuusjoukkojen vapaaehtoishankkeet</a>, <br><a href='https://www.oph.fi/fi/ohjelmat/erasmus-nuorisovaihto' target='_blank' rel='noopener noreferrer'>Erasmus+ nuorisovaihdot</a>.",
