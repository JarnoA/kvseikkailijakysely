...
sv_data = {
    ...
    'rohkaisijakuoriainen': {
        ...
        'desc': "Du ser till että alla känner sig hörda och sedda. Du är redo att hjälpa till i alla situationer. Du viskar uppmuntrande ord och känner till de vägar och möjligheter som ligger framför. Du ger dem omkring dig, både unga och kollegor, mod att bre ut sina vingar inför det nya!",
        ...
        'og_desc': "Du ser till että alla känner sig hörda och sedda. Gör testet och ta reda på vilken karaktär du är!"
    },
    'osallisuuskimalainen': {
        'title': "Du är ett Delaktighetsbi!",
        'desc': "Du surrar av iver när unga hittar nya sätt att göra sin egen röst hörd. Du har tagit som din uppgift att se till että varje liten varelse i trädgården har sin egen plats i gruppen. Du vet vilka stödda rutter som erbjuds till världen, eller så tar du målmedvetet reda på det.",
...
<body class="result-page char-{char_key}">
    <div class="app-container">
        ...
        <div class="content-area">
            ...
            <div class="logo-grid">
                <img src="../../assets/images/{logo}" alt="EDUFI">
                <img src="../../assets/images/Erasmus+_Su_Ru_En.png" alt="Erasmus+">
                <img src="../../assets/images/Solidaarisuusjoukot_logo_Su_En_Ru.png" alt="Solidarity Corps">
...
for lang, data in [('fi', fi_data), ('en', en_data), ('sv', sv_data)]:
    if lang == 'en':
        logo = "OPH_En_vaaka_rgb.png"
    else:
        logo = "OPH_Su_Ru_vaaka_RGB.png"
    ...
    for char_key, content in data.items():
        ...
        file_path = f"kv-hahmokysely/{lang}/tulokset/{char_key}.html"
